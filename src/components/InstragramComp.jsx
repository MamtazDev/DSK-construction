...
const InstraComp = () => {
    ...
    const [serverURL, setServerURL] = useState("https://www.instagram.com/dsk.construction/?utm_source=ig_embed&amp;utm_campaign=loading")
  ...
  return (
         <blockquote className="instagram-media " data-instgrm-permalink={serverURL} data-instgrm-version="14" style={{ background: '#FFF', border: '0', borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth: '50%', minWidth: '326px', padding: '0', width: '99.375%', WebkitWidth: 'calc(100% - 2px)', width: 'calc(100% - 2px)', margin: "50px" }} >
